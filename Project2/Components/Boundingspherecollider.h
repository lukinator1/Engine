	 ...
	 void handleCollision() {
		 ...
		 for (int i = 0; i < boundingsphere.collisiondata.otherobjects.size(); i++) {
			 ...
			 if (raytrace.Trace(boundingsphere.collisiondata.otherobjects[i]->oldpos, dir, &boundingsphere)) {  //angle
				 ...
				 vector3 rb = raytrace.intersectionpoint - boundingsphere.oldpos;
				 vector3 ra = raytrace.intersectionpoint - boundingsphere.collisiondata.otherobjects[i]->oldpos;
				 ...
				 netforce += boundingsphere.collisiondata.forces[i + 1];
